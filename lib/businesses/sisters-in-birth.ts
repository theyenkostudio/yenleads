...
export const sistersInBirth: BusinessData = {
  slug: "sisters-in-birth",
  name: "Sisters in Birth",
  shortName: "SIB",
  tagline: "Empowering Women Through Maternal Care",

  industry: "Maternal Health",
  location: "Pearl, MS",
