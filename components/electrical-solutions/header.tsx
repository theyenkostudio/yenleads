      ...
      <div className="container mx-auto px-6 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          <Image
            ...
            height={40}
          />
          <div className="border border-white h-8 hidden md:block"></div>

          <img
            src="/images/electrical-solutions/veteran-owned.jpeg"
            alt="Veteran Owned"
            className="h-8 hidden sm:block pl-4"
          />
        </div>
        ...
        <div className="hidden lg:flex gap-8 text-[10px] uppercase tracking-[0.2em] font-bold text-stone-400">
          ...
          <a href="#tesla" className="hover:text-blue-400 transition-colors">
            Tesla Energy
          </a>
          <a href="#generac" className="hover:text-blue-400 transition-colors">
            Backup Power
          </a>
