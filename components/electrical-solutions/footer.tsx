    ...
    <footer id="contact" className="bg-stone-950 text-white pt-20 pb-12">
      <div className="container mx-auto px-6 grid lg:grid-cols-3 gap-16 pb-16 border-b border-stone-900">
        ...
        <div className="space-y-6">
          <Image
            src="/images/electrical-solutions/ess-logo.svg"
            alt="ESS Electrical Logo"
            width={80}
            height={40}
          />
          <p className="text-stone-500 text-sm max-w-xs">
            Precision electrical solutions for Rankin County and Central
            Mississippi.
          </p>
          <div className="flex gap-4">
            ...
            <a
              href="#"
              className="w-10 h-10 border border-stone-800 flex items-center justify-center hover:bg-blue-600 transition-all"
            >
        ...
        <div className="space-y-4 text-sm">
          <h4 className="text-[10px] uppercase tracking-[0.2em] text-stone-500 font-bold">
            Operations Hub
          </h4>
          <p className="text-stone-300 italic">
            218 Saint Paul Street, Pearl MS 39208
          </p>
          <div className="pt-4 space-y-1">
            <p className="text-stone-500 uppercase text-[10px] tracking-widest">
              Office Hours
            </p>
        ...
        <div className="space-y-4">
          ...
          <a
            href="tel:7695727597"
            className="block text-3xl font-bold hover:text-blue-500 transition-colors"
          >
            (769) 572-7597
          </a>
